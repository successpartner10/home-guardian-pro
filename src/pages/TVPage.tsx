...
const TVPage = () => {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-[#050505] text-foreground p-6 overflow-hidden ten-ft-ui">
            ...
            >
                <div className="h-32 w-32 rounded-[2.5rem] bg-muted border border-border flex items-center justify-center mb-10 shadow-2xl backdrop-blur-md">
                ...
                <div className="flex gap-4 mb-16">
                    {pairingCode.split('').map((char, i) => (
                        <motion.div
                            ...
                            className="h-20 w-16 sm:h-24 sm:w-20 rounded-2xl bg-muted border-2 border-border flex items-center justify-center text-4xl sm:text-5xl font-black shadow-2xl backdrop-blur-xl"
                        >
                            {char}
                        </motion.div>
                    ))}
                ...
                <div className="flex items-center gap-12 p-8 rounded-[2.5rem] bg-muted border border-border backdrop-blur-md">
